...
% Stefan Schmalholz, July 2020
% Input parameters are explained by comments in the same line.
% Mentioned equation numbers, figure numbers or parameters refer to the
% corresponding manuscript of Schmalholz et al., submitted to EPSL
% The present code calculates the first time step of the HMC model
% displayed in figure 7 in the manuscript
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% -------------------------------------------------------------------------
Lx_rad          = 10;           % LAMBDA_1 in equation (15) in the manuscript; Model width divided by inclusion radius;
Lc_rad2         = 1e8;          % LAMBDA_2 in equation (15) in the manuscript; Lc_rad2 = k_etaf*eta_mat/radius^2; []; Ratio of hydraulic fluid extraction to compaction extraction
lam_eta         = 1e0;          % LAMBDA_3 in equation (15) in the manuscript; lam_eta = lambda / eta_mat; []; Ratio of bulk to shear viscosity
Da              = 0.0024;       % LAMBDA_4 in equation (15) in the manuscript; Da   = eb*eta_mat/P_ini; []; Ratio of viscous stress to initial stress
sig_yield       = 0.024;        % LAMBDA_5 in equation (15) in the manuscript; Stress_ref / P_ini; []; Reference stress used for power-law viscous flow law
...
for smo=1:2 % Smooting of initial perturbation
    Ii               = [2:nx-1];
